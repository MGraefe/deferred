...
editorDoc.h, editorDoc.cpp - the document
    ...
    The Document will have the following strings:
        File extension:      dfmap
        File type ID:        defedt.mapfile
        Main frame caption:  defedt
        Doc type name:       Untitled
        Filter name:         defedt mapfile (*.dfmap)
        File new short name: defedt mapfile
        File type long name: defedt.mapfile
...
res\editorDoc.ico
    ...
    for the CeditorDoc class.  This icon is included by the main
    resource file editor.rc.
