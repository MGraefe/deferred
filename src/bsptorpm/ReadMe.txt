...
﻿========================================================================
    KONSOLENANWENDUNG: bsptorpm-Projektübersicht
========================================================================

Diese bsptorpm-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die bsptorpm-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen bsptorpm.pch sowie eine vorkompilierte 
