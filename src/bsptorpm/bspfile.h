...
//-----------------------------------
//This one is mainly a copy of the original bspfile.h with some edits
...
#ifndef deferred__bsptorpm__bspfile_H__
#define deferred__bsptorpm__bspfile_H__
#pragma once

#include "..\..\src\util\maths.h"

typedef unsigned char byte;
#define Vector2 Vector3f

#define SURF_LIGHT	0x0001	// value will hold the light strength
#define SURF_SLICK	0x0002	// effects game physics
#define SURF_SKY	0x0004	// don't draw, but add to skybox
#define SURF_WARP	0x0008	// turbulent water warp
#define SURF_TRANS	0x0010	// surface is transparent
...
#define SURF_NOLIGHT	0x0400	// Don't calculate light on this surface
...
//class Vector
//{
//public: Vector() { x = 0.0f; y = 0.0f; z = 0.0f; }
...
{
	Vector2		mins, maxs;
	Vector2		origin;			// for sounds or lights
	int			headnode;
...
{
public:
	Vector2		m_vVector;		// Vector field defining displacement volume.
...
public:
	Vector2		startPosition;						// start position used for orientation -- (added BSPVERSION 6)
...
struct dworldlight_t
{
	Vector2		origin;
	Vector2		intensity;
	Vector2		normal;			// for surfaces and spotlights
	int			cluster;
	emittype_t	type;
    int			style;
...
public:
	...
	float		flU[2];
	float		flV[2];
	Vector2		vecUVPoints[4];
	Vector2		vecOrigin;
	Vector2		vecBasisNormal;
};
...
#endif // deferred__bsptorpm__bspfile_H__
